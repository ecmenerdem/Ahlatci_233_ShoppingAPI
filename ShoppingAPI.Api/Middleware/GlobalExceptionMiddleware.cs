        ...
        public async Task InvokeAsync(HttpContext httpContext)
        {
            ...
            catch (Exception e)
            {
               ...
               else if (e.GetType()==typeof(SecurityTokenSignatureKeyNotFoundException))
                {
                    httpContext.Response.StatusCode = (int)HttpStatusCode.Unauthorized;
                    httpContext.Response.ContentType = "application/json";
                    await httpContext.Response.WriteAsJsonAsync(Sonuc<TokenNotFoundException>.TokenValidationError());
                }
                ...
                else
                {
                    ...
                    httpContext.Response.ContentType = "application/json";
                    await httpContext.Response.WriteAsJsonAsync(Sonuc<Exception>.Error());
                }
